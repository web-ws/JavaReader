...
第三阶段：面试+项目说明调整+补充八股文+算法初步理解

第四阶段：深度理解和剖析项目的亮点和难点 + 微服务框架的搭建 + 高并发高可用项目知识理论的研究。

第五阶段：实践面试，每天拿offer，重拾人生的自信，迎难而上，时刻总结失败和填谷的过程。



> 面试总结

公司的三体结构：人员组织架构，薪酬结构（基本工资 + 月绩效年终绩效 + 五一险一金），员工福利

面试成长的过程：从未离职之前的试错，再到推进各方面知识的复习，再次面试，对项目的重新理解，再到八股文的重新理解以及项目的重构，再研究高并发和高可用的技术框架，再到精简八股文的核心知识，再到天天拿offer。

面试知识储备：loser笔记文库，夯实相关的基础知识并做好用自己的言语描述。

避坑：
1） 集团类公司是可以考虑的，福利制度各方面都比较完善。初创公司风向大，对个人能力要求高，身体素质也要求高，暂时不具备相应的条件，需要再次储备能量，重新出发

2） 如果公司不是特别优秀或者出众，距离地铁站太远，没必要考虑。
